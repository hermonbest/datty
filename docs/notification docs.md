...
An [`EventSubscription`](/versions/latest/sdk/notifications.md#eventsubscription) object represents the subscription of the provided listener.
...
| Parameter | Type | Description |
| --- | --- | --- |
| `options`(optional) | [ExpoPushTokenOptions](/versions/latest/sdk/notifications.md#expopushtokenoptions) | Object allowing you to pass in push notification configuration. Default: `{}` |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `listener` | (event: [Notification](/versions/latest/sdk/notifications.md#notification)) => void | A function accepting a notification ([`Notification`](/versions/latest/sdk/notifications.md#notification)) as an argument. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `listener` | (event: [NotificationResponse](/versions/latest/sdk/notifications.md#notificationresponse)) => void | A function accepting notification response ([`NotificationResponse`](/versions/latest/sdk/notifications.md#notificationresponse)) as an argument. |
...
To clear the last notification response, use [`clearLastNotificationResponseAsync()`](/versions/latest/sdk/notifications.md#notificationsclearlastnotificationresponseasync).
...
-   a [`NotificationResponse`](/versions/latest/sdk/notifications.md#notificationresponse) object - if a notification response was received.
...
| Parameter | Type | Description |
| --- | --- | --- |
| `handler` | [NotificationHandler](/versions/latest/sdk/notifications.md#notificationhandler) | null | A single parameter which should be either `null` (if you want to clear the handler) or a [`NotificationHandler`](/versions/latest/sdk/notifications.md#notificationhandler) object. |
...
-   `data`: The remote payload delivered by either FCM (Android) or APNs (iOS). See [`NotificationTaskPayload`](/versions/latest/sdk/notifications.md#notificationtaskpayload) for details.
...
From the callback function, you may return a [`BackgroundNotificationResult`](/versions/latest/sdk/notifications.md#backgroundnotificationtaskresult) value to indicate the result of a background fetch operation on iOS.
...
It returns a `Promise` resolving to an object represents permission settings ([`NotificationPermissionsStatus`](/versions/latest/sdk/notifications.md#notificationpermissionsstatus)). On iOS, make sure you [properly interpret the permissions response](/versions/latest/sdk/notifications.md#interpret-the-ios-permissions-response).
...
| Parameter | Type | Description |
| --- | --- | --- |
| `permissions`(optional) | [NotificationPermissionsRequest](/versions/latest/sdk/notifications.md#notificationpermissionsrequest) | An object representing configuration for the request scope. |
...
Sets the badge of the app's icon to the specified number. Setting it to `0` clears the badge. On iOS, this method requires that you have requested the user's permission for `allowBadge` via [`requestPermissionsAsync`](/versions/latest/sdk/notifications.md#requestpermissionsasyncpermissions), otherwise it will automatically return `false`.
...
Returns a Promise resolving to an array of objects conforming to the [`Notification`](/versions/latest/sdk/notifications.md#notification) interface.
...
| Parameter | Type | Description |
| --- | --- | --- |
| `trigger` | [SchedulableNotificationTriggerInput](/versions/latest/sdk/notifications.md#schedulablenotificationtriggerinput) | The schedulable notification trigger you would like to check next trigger date for (of type [`SchedulableNotificationTriggerInput`](/versions/latest/sdk/notifications.md#schedulablenotificationtriggerinput)). |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `request` | [NotificationRequestInput](/versions/latest/sdk/notifications.md#notificationrequestinput) | An object describing the notification to be triggered. |

  

Schedules a notification to be triggered in the future.

> **Note:** This does not mean that the notification will be presented when it is triggered. For the notification to be presented you have to set a notification handler with [`setNotificationHandler`](/versions/latest/sdk/notifications.md#setnotificationhandlerhandler) that will return an appropriate notification behavior. For more information see the example below.
...
A Promise which resolves with a list of notifications ([`Notification`](/versions/latest/sdk/notifications.md#notification)) currently present in the notification tray (Notification Center).
...
A Promise which resolves to the channel object (of type [`NotificationChannel`](/versions/latest/sdk/notifications.md#notificationchannel)) or to `null` if there was no channel found for this identifier. On platforms that do not support notification channels, it will always resolve to `null`.
...
A Promise which resolves to the channel group object (of type [`NotificationChannelGroup`](/versions/latest/sdk/notifications.md#notificationchannelgroup)) or to `null` if there was no channel group found for this identifier. On platforms that do not support notification channels, it will always resolve to `null`.
...
| --- | --- | --- |
| `channelId` | `string` | The channel identifier. |
| `channel` | [NotificationChannelInput](/versions/latest/sdk/notifications.md#notificationchannelinput) | Object representing the channel's configuration. |
...
For example, for a notification to play a custom sound on Android versions **below** 8.0, the custom notification sound has to be set on the notification (through the [`NotificationContentInput`](/versions/latest/sdk/notifications.md#notificationcontentinput)), and for the custom sound to play on Android versions **above** 8.0, the relevant notification channel must have the custom sound configured (through the [`NotificationChannelInput`](/versions/latest/sdk/notifications.md#notificationchannelinput)). For more information, see [Set custom notification sounds on Android](/versions/latest/sdk/notifications.md#set-custom-notification-sounds).

Returns: `Promise<NotificationChannel | null>`

A Promise which resolving to the object (of type [`NotificationChannel`](/versions/latest/sdk/notifications.md#notificationchannel)) describing the modified channel or to `null` if the platform does not support notification channels.
...
| --- | --- | --- |
| `groupId` | `string` | The channel group's identifier. |
| `group` | [NotificationChannelGroupInput](/versions/latest/sdk/notifications.md#notificationchannelgroupinput) | Object representing the channel group configuration. |
...
A `Promise` resolving to the object (of type [`NotificationChannelGroup`](/versions/latest/sdk/notifications.md#notificationchannelgroup)) describing the modified channel group or to `null` if the platform does not support notification channels.
...
| Parameter | Type | Description |
| --- | --- | --- |
| `identifier` | `string` | A string to associate as the ID of this category. You will pass this string in as the `categoryIdentifier` in your [`NotificationContent`](/versions/latest/sdk/notifications.md#notificationcontent) to associate a notification with this category. Don't use the characters : or - in your category identifier. If you do, categories might not work as expected. |
| `actions` | [NotificationAction[]](/versions/latest/sdk/notifications#notificationaction) | An array of [`NotificationAction`](/versions/latest/sdk/notifications.md#notificationaction), which describe the actions associated with this category. |
| `options`(optional) | [NotificationCategoryOptions](/versions/latest/sdk/notifications.md#notificationcategoryoptions) | An optional object of additional configuration options for your category. |
...
If a component is using the [`useLastNotificationResponse`](/versions/latest/sdk/notifications.md#uselastnotificationresponse) hook, this call will also clear the value returned by the hook.
...
| --- | --- | --- |
| contentType | [AndroidAudioContentType](/versions/latest/sdk/notifications.md#androidaudiocontenttype) | - |
| flags | `{ enforceAudibility: boolean, requestHardwareAudioVideoSynchronization: boolean }` | - |
| usage | [AndroidAudioUsage](/versions/latest/sdk/notifications.md#androidaudiousage) | - |

### `BeaconRegion`

Supported platforms: iOS.

Extends: [Region](/versions/latest/sdk/notifications.md#region)
...
| devicePushToken(optional) | [DevicePushToken](/versions/latest/sdk/notifications.md#devicepushtoken) | The device push token with which to register at the backend. Defaults to a token fetched with [`getDevicePushTokenAsync()`](/versions/latest/sdk/notifications.md#getdevicepushtokenasync). |
...
| notification | [FirebaseRemoteMessageNotification](/versions/latest/sdk/notifications.md#firebaseremotemessagenotification) | null | - |
...
| Property | Type | Description |
| --- | --- | --- |
| region | [CircularRegion](/versions/latest/sdk/notifications.md#circularregion) | [BeaconRegion](/versions/latest/sdk/notifications.md#beaconregion) | - |
| repeats | `boolean` | - |
| type | `'location'` | - |
...
An object which represents a single notification that has been triggered by some request ([`NotificationRequest`](/versions/latest/sdk/notifications.md#notificationrequest)) at some point in time.

| Property | Type | Description |
| --- | --- | --- |
| date | `number` | - |
| request | [NotificationRequest](/versions/latest/sdk/notifications.md#notificationrequest) | - |
...
| identifier | `string` | A unique string that identifies this action. If a user takes this action (for example, selects this button in the system's Notification UI), your app will receive this `actionIdentifier` via the [`NotificationResponseReceivedListener`](/versions/latest/sdk/notifications.md#addnotificationresponsereceivedlistenerlistener). |
...
| Property | Type | Description |
| --- | --- | --- |
| priority(optional) | [AndroidNotificationPriority](/versions/latest/sdk/notifications.md#androidnotificationpriority) | - |
...
Categories must be registered with [`setNotificationCategoryAsync`](/versions/latest/sdk/notifications.md#setnotificationcategoryasyncidentifier-actions-options) before they can be used. When scheduling a notification, reference the category by its `identifier` in the [`NotificationContentInput.categoryIdentifier`](/versions/latest/sdk/notifications.md#notificationcontentinput) field.

| Property | Type | Description |
| --- | --- | --- |
| actions | [NotificationAction[]](/versions/latest/sdk/notifications#notificationaction) | - |
| identifier | `string` | - |
| options(optional) | [NotificationCategoryOptions](/versions/latest/sdk/notifications.md#notificationcategoryoptions) | - |
...
| Property | Type | Description |
| --- | --- | --- |
| audioAttributes | [AudioAttributes](/versions/latest/sdk/notifications.md#audioattributes) | - |
| bypassDnd | `boolean` | - |
...
| id | `string` | - |
| importance | [AndroidImportance](/versions/latest/sdk/notifications.md#androidimportance) | - |
| lightColor | `string` | - |
| lockscreenVisibility | [AndroidNotificationVisibility](/versions/latest/sdk/notifications.md#androidnotificationvisibility) | - |
| name | `string | null` | - |
| showBadge | `boolean` | - |
...
| Property | Type | Description |
| --- | --- | --- |
| channels | [NotificationChannel[]](/versions/latest/sdk/notifications#notificationchannel) | - |
...
| getNotificationChannelGroupAsync(optional) | (groupId: string) => [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)<[NotificationChannelGroup](/versions/latest/sdk/notifications.md#notificationchannelgroup) | null\> | - |
| getNotificationChannelGroupsAsync(optional) | () => [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)<[NotificationChannelGroup[]](/versions/latest/sdk/notifications#notificationchannelgroup)\> | - |
| setNotificationChannelGroupAsync(optional) | (groupId: string, group: [NotificationChannelGroupInput](/versions/latest/sdk/notifications.md#notificationchannelgroupinput)) => [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)<[NotificationChannelGroup](/versions/latest/sdk/notifications.md#notificationchannelgroup) | null\> | - |
...
| getNotificationChannelAsync(optional) | (channelId: string) => [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)<[NotificationChannel](/versions/latest/sdk/notifications.md#notificationchannel) | null\> | - |
| getNotificationChannelsAsync(optional) | () => [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)<[NotificationChannel[]](/versions/latest/sdk/notifications#notificationchannel) | null\> | - |
| setNotificationChannelAsync(optional) | (channelId: string, channelConfiguration: [NotificationChannelInput](/versions/latest/sdk/notifications.md#notificationchannelinput)) => [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)<[NotificationChannel](/versions/latest/sdk/notifications.md#notificationchannel) | null\> | - |
...
| Property | Type | Description |
| --- | --- | --- |
| handleError(optional) | (notificationId: string, error: [NotificationHandlingError](/versions/latest/sdk/notifications.md#notificationhandlingerror)) => void | A function called whenever calling `handleNotification()` for an incoming notification fails. |
| handleNotification | (notification: [Notification](/versions/latest/sdk/notifications.md#notification)) => [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)<[NotificationBehavior](/versions/latest/sdk/notifications.md#notificationbehavior)\> | A function accepting an incoming notification returning a `Promise` resolving to a behavior ([`NotificationBehavior`](/versions/latest/sdk/notifications.md#notificationbehavior)) applicable to the notification |
...
| ios(optional) | [IosNotificationPermissionsRequest](/versions/latest/sdk/notifications.md#iosnotificationpermissionsrequest) | Available configuration for permission request on iOS platform. |
...
| ios(optional) | { alertStyle: [IosAlertStyle](/versions/latest/sdk/notifications.md#iosalertstyle), allowsAlert: boolean | null, allowsAnnouncements: boolean | null, allowsBadge: boolean | null, allowsCriticalAlerts: boolean | null, allowsDisplayInCarPlay: boolean | null, allowsDisplayInNotificationCenter: boolean | null, allowsDisplayOnLockScreen: boolean | null, allowsPreviews: [IosAllowsPreviews](/versions/latest/sdk/notifications.md#iosallowspreviews) | null, allowsSound: boolean | null, providesAppNotificationSettings: boolean | null, status: [IosAuthorizationStatus](/versions/latest/sdk/notifications.md#iosauthorizationstatus) } | - |

### `NotificationRequest`

Supported platforms: Android, iOS.

An object represents a request to present a notification. It has content — how it's being represented, and a trigger — what triggers the notification. Many notifications ([`Notification`](/versions/latest/sdk/notifications.md#notification)) may be triggered with the same request (for example, a repeating notification).

| Property | Type | Description |
| --- | --- | --- |
| content | [NotificationContent](/versions/latest/sdk/notifications.md#notificationcontent) | - |
| identifier | `string` | - |
| trigger | [NotificationTrigger](/versions/latest/sdk/notifications.md#notificationtrigger) | - |
...
| Property | Type | Description |
| --- | --- | --- |
| content | [NotificationContentInput](/versions/latest/sdk/notifications.md#notificationcontentinput) | - |
| identifier(optional) | `string` | - |
| trigger | [NotificationTriggerInput](/versions/latest/sdk/notifications.md#notificationtriggerinput) | - |
...
> **Note:** If the user taps on a notification, `actionIdentifier` will be equal to [`Notifications.DEFAULT_ACTION_IDENTIFIER`](/versions/latest/sdk/notifications.md#notificationsdefault_action_identifier).

| Property | Type | Description |
| --- | --- | --- |
| actionIdentifier | `string` | - |
| notification | [Notification](/versions/latest/sdk/notifications.md#notification) | - |
...
Type: [Partial](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)<[AudioAttributes](/versions/latest/sdk/notifications.md#audioattributes)\>
...
Acceptable values are: [ExplicitlySupportedDevicePushToken](/versions/latest/sdk/notifications.md#explicitlysupporteddevicepushtoken) | [ImplicitlySupportedDevicePushToken](/versions/latest/sdk/notifications.md#implicitlysupporteddevicepushtoken)

### `ExplicitlySupportedDevicePushToken`

Supported platforms: Android, iOS.

Type: [NativeDevicePushToken](/versions/latest/sdk/notifications.md#nativedevicepushtoken)
...
Acceptable values are: [IosNotificationPermissionsRequest](/versions/latest/sdk/notifications.md#iosnotificationpermissionsrequest) | `object`
...
Type: RequiredBy<[Omit](https://www.typescriptlang.org/docs/handbook/utility-types.html#omittype-keys)<[NotificationChannel](/versions/latest/sdk/notifications.md#notificationchannel), 'id' | 'audioAttributes' | 'sound'\> & { audioAttributes: [AudioAttributesInput](/versions/latest/sdk/notifications.md#audioattributesinput), sound: string | null }, 'name' | 'importance'\>
...
An object representing notification's content when reading a notification (on the "output", when it is presented by the system). For the input type, see [`NotificationContentInput`](/versions/latest/sdk/notifications.md#notificationcontentinput).

Type: [NotificationContentIos](/versions/latest/sdk/notifications.md#notificationcontentios) | [NotificationContentAndroid](/versions/latest/sdk/notifications.md#notificationcontentandroid) extended by:
...
| Property | Type | Description |
| --- | --- | --- |
| attachments(optional) | [NotificationContentAttachmentIos[]](/versions/latest/sdk/notifications#notificationcontentattachmentios) | Supported platforms: iOS. The visual and audio attachments to display alongside the notification’s main content. |
...
| data(optional) | `Record<string, unknown>` | Data associated with the notification, not displayed. |
| interruptionLevel(optional) | [InterruptionLevel](/versions/latest/sdk/notifications.md#interruptionlevel) | Supported platforms: iOS. The notification’s importance and required delivery timing. Possible values:
-   'passive' - the system adds the notification to the notification list without lighting up the screen or playing a sound
-   'active' - the system presents the notification immediately, lights up the screen, and can play a sound
-   'timeSensitive' - The system presents the notification immediately, lights up the screen, can play a sound, and breaks through system notification controls
-   'critical - the system presents the notification immediately, lights up the screen, and bypasses the mute switch to play a sound
...
| sound(optional) | `boolean | 'default' | 'defaultCritical' | 'defaultRingtone' | string & undefined` | The notification sound. Use `false` for a silent notification. On Android version 8 and later, control the sounds via [notification channels](/versions/latest/sdk/notifications.md#setnotificationchannelasyncchannelid-channel). `defaultCritical` and `defaultRingtone` are applicable only on iOS, with `defaultCritical` requiring the critical alerts entitlement. On iOS, you can also provide a custom sound filename including the extension. The file needs to be added to the `expo-notifications` config plugin `sounds` array in your app config. |
...
| Property | Type | Description |
| --- | --- | --- |
| attachments | [NotificationContentAttachmentIos[]](/versions/latest/sdk/notifications#notificationcontentattachmentios) | The visual and audio attachments to display alongside the notification’s main content. |
| badge | `number | null` | The number that your app’s icon displays. |
| interruptionLevel(optional) | [InterruptionLevel](/versions/latest/sdk/notifications.md#interruptionlevel) | - |
...
Payload for the background notification handler task. See [Run JavaScript in response to incoming notifications](/versions/latest/sdk/notifications.md#run-javascript-in-response-to-incoming-notifications).

Type: [NotificationResponse](/versions/latest/sdk/notifications.md#notificationresponse) or `object` shaped as below:
...
Acceptable values are: [PushNotificationTrigger](/versions/latest/sdk/notifications.md#pushnotificationtrigger) | [LocationNotificationTrigger](/versions/latest/sdk/notifications.md#locationnotificationtrigger) | [NotificationTriggerInput](/versions/latest/sdk/notifications.md#notificationtriggerinput) | [UnknownNotificationTrigger](/versions/latest/sdk/notifications.md#unknownnotificationtrigger)
...
Acceptable values are: `null` | [ChannelAwareTriggerInput](/versions/latest/sdk/notifications.md#channelawaretriggerinput) | [SchedulableNotificationTriggerInput](/versions/latest/sdk/notifications.md#schedulablenotificationtriggerinput)
...
| remoteMessage(optional) | [FirebaseRemoteMessage](/versions/latest/sdk/notifications.md#firebaseremotemessage) | Supported platforms: Android. |
| type | `'push'` | - |
...
A function accepting a device push token ([`DevicePushToken`](/versions/latest/sdk/notifications.md#devicepushtoken)) as an argument.
...
| Parameter | Type |
| --- | --- |
| `token` | [DevicePushToken](/versions/latest/sdk/notifications.md#devicepushtoken) |
...
Input for time-based, schedulable triggers. For these triggers you can check the next trigger date with [`getNextTriggerDateAsync`](/versions/latest/sdk/notifications.md#getnexttriggerdateasynctrigger). If you pass in a `number` (Unix timestamp) or `Date`, it will be processed as a trigger input of type [`SchedulableTriggerInputTypes.DATE`](/versions/latest/sdk/notifications.md#date). Otherwise, the input must be an object, with a `type` value set to one of the allowed values in [`SchedulableTriggerInputTypes`](/versions/latest/sdk/notifications.md#schedulabletriggerinputtypes). If the input is an object, date components passed in will be validated, and an error is thrown if they are outside their allowed range (for example, the `minute` and `second` components must be between 0 and 59 inclusive).

Acceptable values are: [CalendarTriggerInput](/versions/latest/sdk/notifications.md#calendartriggerinput) | [TimeIntervalTriggerInput](/versions/latest/sdk/notifications.md#timeintervaltriggerinput) | [DailyTriggerInput](/versions/latest/sdk/notifications.md#dailytriggerinput) | [WeeklyTriggerInput](/versions/latest/sdk/notifications.md#weeklytriggerinput) | [MonthlyTriggerInput](/versions/latest/sdk/notifications.md#monthlytriggerinput) | [YearlyTriggerInput](/versions/latest/sdk/notifications.md#yearlytriggerinput) | [DateTriggerInput](/versions/latest/sdk/notifications.md#datetriggerinput)

> **Deprecated:** use the [`EventSubscription`](/versions/latest/sdk/notifications.md#eventsubscription) type instead
