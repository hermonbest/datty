...
Preferred command:
npx --yes submit-expo-feedback@latest --category docs --subject "/versions/v54.0.0/sdk/audio/" "<actionable feedback>"

Direct HTTP fallback:
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/versions/v54.0.0/sdk/audio/","feedback":"🤖 Agent feedback for docs: <specific, actionable description> (<model>, <harness>)"}'
...
You are here: Reference (v54.0.0) > Expo SDK (85 pages in this section)
...
> **Note:** If you're migrating from [`expo-av`](/versions/v54.0.0/sdk/av.md), you'll notice that `expo-audio` doesn't automatically reset the playback position when audio finishes. After [`play()`](/versions/v54.0.0/sdk/audio.md#play), the player stays paused at the end of the sound. To play it again, call [`seekTo(seconds)`](/versions/v54.0.0/sdk/audio.md#seektoseconds-tolerancemillisbefore-tolerancemillisafter) to reset the position — as shown in the example above.
...
In most cases, the [`useAudioPlayer`](/versions/v54.0.0/sdk/audio.md#useaudioplayersource-options) hook should be used to create a `AudioPlayer` instance. It manages the player's lifecycle and ensures that it is properly disposed of when the component is unmounted. However, in some advanced use cases, it might be necessary to create a `AudioPlayer` that does not get automatically destroyed when the component is unmounted. In those cases, the `AudioPlayer` can be created using the [`createAudioPlayer`](/versions/v54.0.0/sdk/audio.md#audiocreateaudioplayersource-options) function. You need to be aware of the risks that come with this approach, as it is your responsibility to call the [`release()`](/versions/v54.0.0/sdk/expo.md#release) method when the player is no longer needed. If not handled properly, this approach may lead to memory leaks.
...
Type: { HIGH_QUALITY: [RecordingOptions](/versions/v54.0.0/sdk/audio.md#recordingoptions), LOW_QUALITY: [RecordingOptions](/versions/v54.0.0/sdk/audio.md#recordingoptions) }
...
| --- | --- | --- |
| `source`(optional) | [AudioSource](/versions/v54.0.0/sdk/audio.md#audiosource) | The audio source to load. Can be a local asset via `require()`, a remote URL, or null for no initial source. Default: `null` |
| `options`(optional) | [AudioPlayerOptions](/versions/v54.0.0/sdk/audio.md#audioplayeroptions) | Audio player configuration options. Default: `{}` |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `player` | [AudioPlayer](/versions/v54.0.0/sdk/audio.md#audioplayer) | The `AudioPlayer` instance to monitor. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `options` | [RecordingOptions](/versions/v54.0.0/sdk/audio.md#recordingoptions) | Recording configuration options including format, quality, sample rate, etc. |
| `statusListener`(optional) | (status: [RecordingStatus](/versions/v54.0.0/sdk/audio.md#recordingstatus)) => void | Optional callback function that receives recording status updates. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `recorder` | [AudioRecorder](/versions/v54.0.0/sdk/audio.md#audiorecorder) | The `AudioRecorder` instance to monitor. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `player` | [AudioPlayer](/versions/v54.0.0/sdk/audio.md#audioplayer) | The `AudioPlayer` instance to sample audio from. |
| `listener` | (data: [AudioSample](/versions/v54.0.0/sdk/audio.md#audiosample)) => void | Function called with each audio sample containing waveform data. |
...
Type: Class extends [SharedObject](/versions/v54.0.0/sdk/expo.md#sharedobjecttype)<[AudioEvents](/versions/v54.0.0/sdk/audio.md#audioevents)\>
...
| Parameter | Type |
| --- | --- |
| `source` | [AudioSource](/versions/v54.0.0/sdk/audio.md#audiosource) |
...
| `metadata`(optional) | [AudioMetadata](/versions/v54.0.0/sdk/audio.md#audiometadata) | Optional metadata to display on the lock screen (title, artist, album, artwork). |
| `options`(optional) | [AudioLockScreenOptions](/versions/v54.0.0/sdk/audio.md#audiolockscreenoptions) | Optional configuration to configure the lock screen controls. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `rate` | `number` | The playback rate of the audio. See [`playbackRate`](/versions/v54.0.0/sdk/audio.md#playbackrate) property for detailed range information. |
| `pitchCorrectionQuality`(optional) | [PitchCorrectionQuality](/versions/v54.0.0/sdk/audio.md#pitchcorrectionquality) | The quality of the pitch correction. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `metadata` | [AudioMetadata](/versions/v54.0.0/sdk/audio.md#audiometadata) | The metadata to display (title, artist, album, artwork). |
...
Type: Class extends [SharedObject](/versions/v54.0.0/sdk/expo.md#sharedobjecttype)<[RecordingEvents](/versions/v54.0.0/sdk/audio.md#recordingevents)\>
...
| Parameter | Type |
| --- | --- |
| `options`(optional) | [Partial](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)<[RecordingOptions](/versions/v54.0.0/sdk/audio.md#recordingoptions)\> |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `options`(optional) | [RecordingStartOptions](/versions/v54.0.0/sdk/audio.md#recordingstartoptions) | Optional recording configuration options. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `source`(optional) | [AudioSource](/versions/v54.0.0/sdk/audio.md#audiosource) | The audio source to load. Default: `null` |
| `options`(optional) | [AudioPlayerOptions](/versions/v54.0.0/sdk/audio.md#audioplayeroptions) | Audio player configuration options. Default: `{}` |
...
> For most use cases you should use the [`useAudioPlayer`](/versions/v54.0.0/sdk/audio.md#useaudioplayersource-options) hook instead. See the [Using the `AudioPlayer` directly](/versions/v54.0.0/sdk/audio.md#using-the-audioplayer-directly) section for more details.
...
| Parameter | Type | Description |
| --- | --- | --- |
| `mode` | [Partial](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)<[AudioMode](/versions/v54.0.0/sdk/audio.md#audiomode)\> | Partial audio mode configuration object. Only specified properties will be updated. |
...
| --- | --- | --- |
| audioSampleUpdate | (data: [AudioSample](/versions/v54.0.0/sdk/audio.md#audiosample)) => void | Fired when audio sampling is enabled and new sample data is available. |
| playbackStatusUpdate | (status: [AudioStatus](/versions/v54.0.0/sdk/audio.md#audiostatus)) => void | Fired when the player's status changes (play/pause/seek/load and so on.). |
...
Type: [AudioPlayerOptions](/versions/v54.0.0/sdk/audio.md#audioplayeroptions)
...
| interruptionMode | [InterruptionMode](/versions/v54.0.0/sdk/audio.md#interruptionmode) | Determines how the audio session interacts with other audio sessions.
...
-   `'mixWithOthers'`: Audio plays alongside other apps without interrupting them. On Android, this means no audio focus is requested. Best suited for sound effects, UI feedback, or short audio clips.
 ...
 |
| interruptionModeAndroid(optional) | [InterruptionModeAndroid](/versions/v54.0.0/sdk/audio.md#interruptionmodeandroid) | Deprecated: Use interruptionMode instead, which now works on both platforms. Supported platforms: Android. Determines how the audio session interacts with other sessions on Android. |
...
| Property | Type | Description |
| --- | --- | --- |
| channels | [AudioSampleChannel[]](/versions/v54.0.0/sdk/audio#audiosamplechannel) | Array of audio channels, each containing PCM frame data. Stereo audio will have 2 channels (left/right). |
...
Type: [InterruptionMode](/versions/v54.0.0/sdk/audio.md#interruptionmode)
...
| Property | Type | Description |
| --- | --- | --- |
| recordingStatusUpdate | (status: [RecordingStatus](/versions/v54.0.0/sdk/audio.md#recordingstatus)) => void | Fired when the recorder's status changes (start/stop/pause/error, and so on). |
...
| Property | Type | Description |
| --- | --- | --- |
| android | [RecordingOptionsAndroid](/versions/v54.0.0/sdk/audio.md#recordingoptionsandroid) | Supported platforms: Android. Recording options for the Android platform. |
| bitRate | `number` | The desired bit rate. Example. `128000` |
| extension | `string` | The desired file extension. Example. `.caf` |
| ios | [RecordingOptionsIos](/versions/v54.0.0/sdk/audio.md#recordingoptionsios) | Supported platforms: iOS. Recording options for the iOS platform. |
...
| web | [RecordingOptionsWeb](/versions/v54.0.0/sdk/audio.md#recordingoptionsweb) | Supported platforms: Web. Recording options for the Web platform. |
...
| Property | Type | Description |
| --- | --- | --- |
| audioEncoder | [AndroidAudioEncoder](/versions/v54.0.0/sdk/audio.md#androidaudioencoder) | The desired audio encoder. See the [`AndroidAudioEncoder`](/versions/v54.0.0/sdk/audio.md#androidaudioencoder) type for all valid values. |
| audioSource(optional) | [RecordingSource](/versions/v54.0.0/sdk/audio.md#recordingsource) | The desired audio Source. See the [`RecordingSource`](/versions/v54.0.0/sdk/audio.md#recordingsource) type for all valid values. |
...
| outputFormat | [AndroidOutputFormat](/versions/v54.0.0/sdk/audio.md#androidoutputformat) | The desired file format. See the [`AndroidOutputFormat`](/versions/v54.0.0/sdk/audio.md#androidoutputformat) type for all valid values. |
...
| Property | Type | Description |
| --- | --- | --- |
| audioQuality | [AudioQuality](/versions/v54.0.0/sdk/audio.md#audioquality) | number | The desired audio quality. See the [`AudioQuality`](/versions/v54.0.0/sdk/audio.md#audioquality) enum for all valid values. |
...
| outputFormat(optional) | string | [IOSOutputFormat](/versions/v54.0.0/sdk/audio.md#iosoutputformat) | number | The desired file format. See the [`IOSOutputFormat`](/versions/v54.0.0/sdk/audio.md#iosoutputformat) enum for all valid values. |
| sampleRate(optional) | `number` | The desired sample rate. Example. `44100` |
